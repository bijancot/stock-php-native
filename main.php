...
<html>
  <head>
    ...
    <meta name="description" content="Aplikasi Web: Stok Barang">
    <meta name="author" content="DITUMBAS.COM" />
  ...
  <body class="skin-blue fixed">
    <div class="wrapper">
      ...
      <header class="main-header">
        <!-- Logo -->
        <a href="?module=home" class="logo">STOK BARANG</a>
