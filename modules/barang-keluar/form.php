...
?> 
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="?module=barang_keluar">TRANSAKSI BARANG KELUAR</a></li>
          ...
          <form role="form" class="form-horizontal" action="modules/barang-keluar/proses.php?act=insert" method="POST" name="formBarangKeluar">
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <select class="chosen-select" name="id_barang" data-placeholder="--- PILIH ---" onchange="tampil_barang(this)" autocomplete="off" required>
