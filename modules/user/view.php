...
<section class="content-header">
  <h1>
    <i class="fa fa-user icon-title"></i> PENGGUNA
  ...
  <div class="row">
    ...
    elseif ($_GET['alert'] == 6) {
      echo "<div class='alert alert-danger alert-dismissable'>
              <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
              <h4>  <i class='icon fa fa-times-circle'></i> GAGAL</h4>
              Ukuran Foto Tidak Lebih Dari 1MB
            </div>";
    }
    // jika alert = 7
          ...
          <table id="dataTables1" class="table table-bordered table-striped table-hover">
            ...
            // menampilkan isi tabel dari database ke tabel di aplikasi
              ...
              echo "  <td class='center'>$data[username]</td>
                      ...
                      <td class='center'>$data[hak_akses]</td>
                      <td class='center'>$data[status]</td>
                      <td class='center' width='100'>
                          <div>";

                          if ($data['status']=='aktif') { ?>
                            <a data-toggle="tooltip" data-placement="top" title="NONAKTIFKAN" style="margin-right:5px" class="btn btn-warning btn-sm" href="modules/user/proses.php?act=off&id=<?php echo $data['id_user'];?>">
            ...
            <?php
              ...
              echo "      <a data-toggle='tooltip' data-placement='top' title='GANTI' class='btn btn-primary btn-sm' href='?module=form_user&form=edit&id=$data[id_user]'>
