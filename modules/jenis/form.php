...
if ($_GET['form']=='add') { ?> 
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="?module=jenis">DATA JENIS BARANG</a></li>
          ...
          <form role="form" class="form-horizontal" action="modules/jenis/proses.php?act=insert" method="POST">
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control" name="nama_jenis" placeholder="JENIS" autocomplete="off" required>
                </div>
              </div>
          ...
          <form role="form" class="form-horizontal" action="modules/jenis/proses.php?act=update" method="POST">
            <div class="box-body">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label">JENIS</label>
                <div class="col-sm-5">
                  <input type="text" class="form-control" name="nama_jenis" placeholder="JENIS" autocomplete="off" value="<?php echo $data['nama_jenis']; ?>" required>
                </div>
              </div>
