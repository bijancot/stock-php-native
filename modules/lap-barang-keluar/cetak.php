...
<html xmlns="http://www.w3.org/1999/xhtml"> <!-- Bagian halaman HTML yang akan konvert -->
    ...
    <?php
        ...
        <div id="title-tanggal">
            Tanggal <?php echo tgl_eng_to_ind($tgl1); ?> Sampai <?php echo tgl_eng_to_ind($tgl2); ?>
        </div>
    <?php
    }
    ?>
            ...
            <table width="100%" border="0.3" cellpadding="0" cellspacing="0">
                <thead style="background:#e8ecee">
                    <tr class="tr-title">
                        ...
                        <th height="20" align="center" valign="middle">TRANSAKSI</th>
                        <th height="20" align="center" valign="middle">TANGGAL</th>
                        <th height="20" align="center" valign="middle">ID</th>
...
?>	
            ...
            <div id="footer-tanggal">
                Banyuwangi, <?php echo tgl_eng_to_ind("$hari_ini"); ?>
            </div>
            ...
            <div id="footer-nama">
                TITO PUTRA PAMUNGKAS
            </div>
        </div>
    </body>
</html><!-- Akhir halaman HTML yang akan di konvert -->
<?php
$filename="laporan_barang_keluar.pdf"; //ubah untuk menentukan nama file pdf yang dihasilkan nantinya
//==========================================================================================================
