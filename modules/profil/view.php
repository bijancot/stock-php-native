...
<section class="content-header">
  <h1>
    <i class="fa fa-user icon-title"></i> PROFIL
  </h1>
  <ol class="breadcrumb">
...
<section class="content">
  <div class="row">
    ...
    echo "  <div class='alert alert-danger alert-dismissible' role='alert'>
              ...
              <strong><i class='fa fa-check-circle'></i> GAGAL</strong> Format Foto Salah
            </div>";
    }
    // jika alert = 3
    ...
    echo "  <div class='alert alert-danger alert-dismissible' role='alert'>
              ...
              <strong><i class='fa fa-check-circle'></i> GAGAL</strong> Ukuran Foto Maksimal 1MB
            </div>";
    }
    // jika alert = 4
    ...
    echo "  <div class='alert alert-danger alert-dismissible' role='alert'>
              ...
              <strong><i class='fa fa-check-circle'></i> GAGAL</strong> Pastikan Format Foto .JPG / .JPEG / .PNG
            </div>";
    }
    ?>
          ...
          <div class="box-footer">
            <div class="form-group">
              <div class="col-sm-offset-2 col-sm-10">
                <input type="submit" class="btn btn-primary btn-submit" name="ganti" value="GANTI">
              </div>
            </div>
          </div><!-- /.box footer -->
        </form>
