...
<section class="content-header">
  <h1>
    <i class="fa fa-lock icon-title"></i> PASSWORD
  </h1>
  <ol class="breadcrumb">
  ...
  <div class="row">
    ...
    elseif ($_GET['alert'] == 2) {
      echo "<div class='alert alert-danger alert-dismissable'>
              <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
              <h4>  <i class='icon fa fa-times-circle'></i> GAGAL</h4>
              Password Baru / Ulangi Password Baru Tidak Cocok
            </div>";
    }
    // jika alert = 3
    ...
    elseif ($_GET['alert'] == 3) {
      echo "<div class='alert alert-success alert-dismissable'>
              ...
              Password Lama Berhasil Diganti
            </div>";
    }
    ?>
        ...
        <form role="form" class="form-horizontal" method="POST" action="modules/password/proses.php">
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <input type="password" class="form-control" name="old_pass" placeholder="PASSWORD LAMA" autocomplete="off" required>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <input type="password" class="form-control" name="new_pass" placeholder="PASSWORD BARU" autocomplete="off" required>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <input type="password" class="form-control" name="retype_pass" placeholder="ULANGI PASSWORD BARU" autocomplete="off" required>
              </div>
            </div>
          </div><!-- /.box-body -->
