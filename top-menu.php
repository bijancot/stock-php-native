...
<li class="dropdown user user-menu">
  ...
  <?php  
  if ($data['foto']=="") { ?>
    <img src="images/user/user-default.png" class="user-image" alt="FOTO"/>
  <?php
  }
  else { ?>
    <img src="images/user/<?php echo $data['foto']; ?>" class="user-image" alt="FOTO"/>
  <?php
  }
  ?>
  ...
  <ul class="dropdown-menu">
    ...
    <li class="user-header">
      ...
      <?php  
      if ($data['foto']=="") { ?>
        <img src="images/user/user-default.png" class="img-circle" alt="FOTO"/>
      <?php
      }
      else { ?>
        <img src="images/user/<?php echo $data['foto']; ?>" class="img-circle" alt="FOTO"/>
      <?php
      }
      ?>
